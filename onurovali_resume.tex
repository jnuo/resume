...
\begin{document}
  ...
  \section{Employment}
    ...
    \subsection{\noindent\textbox{Technical Product Manager\hfill}\textbox{\hfil Biletbank.com\hfil}\textbox{\hfill Aug 2015 - Aug 2017}}
      Lead the microservices transformation project for B2B online travel agency (\textbf{SaaS} product).\\
    ...
    \subsection{\noindent\textbox{Software Developer / Analyst\hfill}\textbox{\hfil Isbank\hfil}\textbox{\hfill Nov 2010 - Aug 2015}}
      Full-stack developer for Isbank Internet Branch\\
  ...
  \section{Skills, Knowledge \& Tools}
    \subsection{Product Management}
      $\bullet$ Worked on software development, project management and product management sides of \textbf{product development} in different \textbf{agile teams} and companies, mostly using \textbf{Scrum}.\\
